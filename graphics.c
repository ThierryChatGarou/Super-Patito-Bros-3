...
@return Retorna 0 en éxito y 1 si falla la inicialización.
**/
...
Termina el programa el presionar el botón de cerrar
Esta función es un CALLBACK y es llamada por el sistema operativo.
...
@param hwnd: Ventana que contiene el área para dibujar en OpenGL
...
/**
Deshabilita OpenGl y libera los recursos utiñlizados.
@param hwnd: Ventana que contiene el área de dibujo en OpenGL
@param hDC: contexto del dispositivo
@param hRC: contexto del sistema de renderizado.
**/
...
/**
Obtiene las coordenadas del ratón en la ventana en el espacio cliente
...
* @param [in] x,y,x2,y2: Dibuja un rectángulo desde x,y hasta x2,y2
* @param [in] r,g,b:  color en formato RGB
* @return no retorna.
* @remarks metodo ineficiente, ya que usa glBegin() y glEnd() por cada linea. los colores tienen un valor de 0 a 255
**/
...
* @return no retorna.
* @remarks metodo ineficiente, ya que usa glBegin() y glEnd() por cada linea. los colores tienen un valor de 0 a 255
*          Dibuja incluyendo x2,y2 del mismo modo que la clasica librería BGI
**/
...
* @param x,y,x2,y2: Dibuja un rectángulo desde x,y hasta x2,y2
* @return no retorna.
...
* @param x,y: posición x,y del centro del circulo
...
* @param [in] i,j: posición x,y de la imagen
...
* @param i,j: posición x,y de la imagen
